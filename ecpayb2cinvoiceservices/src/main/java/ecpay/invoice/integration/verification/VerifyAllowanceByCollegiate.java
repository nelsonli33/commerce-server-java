...
public class VerifyAllowanceByCollegiate extends InvoiceVerifyBase{
	public VerifyAllowanceByCollegiate(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("InvoiceAllowanceByCollegiate").item(0);
		String url = "";
	...
	public void verifyParams(AllowanceByCollegiateObj obj){
...
//			requireCheck(tmpEle.getAttribute("name"), objValue, tmpEle.getAttribute("require").toString());
			...
			verifyAllowanceByCollegiate(obj);
		}
	}
}
